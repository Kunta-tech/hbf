...
impl<'a> Parser<'a> {
    ...
    fn parse_top_level(&mut self) -> Stmt {
        ...
        match &self.current_token {
            ...
            Token::Int | Token::Cell | Token::Bool | Token::Char | Token::String => {
                ...
                if let Token::Identifier(name) = &self.current_token {
                    ...
                    if self.current_token == Token::LParen {
                        // It's a function
                        self.parse_function_decl_rest(var_type, name_clone)
                    } else {
                ...
                if self.current_token == Token::Equals {
                    ...
                    match expr {
                        ...
                        Expr::ArrayAccess { array, index } => {
                            ...
                            if let Expr::Variable(name) = *array {
                                ...
                                Stmt::IndexedAssign {
                                    ...
                                    value: Expr::BinaryOp {
                                        ...
                                        left: Box::new(Expr::ArrayAccess { array: Box::new(Expr::Variable(name)), index }),
                            ...
                            } else { panic!("++ can only be applied to variables or array elements"); }

                        },

                        _ => panic!("++ can only be applied to variables or array elements"),
            ...
            Token::Set | Token::Copy | Token::Move | Token::Clear | Token::Add | Token::Sub => {
    ...
    fn parse_function_decl(&mut self) -> Stmt {
        ...
        self.advance();
        self.parse_function_decl_rest(return_type, name)
    }

    fn parse_function_decl_rest(&mut self, return_type: Type, name: String) -> Stmt {
        self.eat(Token::LParen);
